...
const Cart = () => {
  ...
  // Optional: Show loading while products load (if products is async)
    ...
    <div className="border-t pt-14">
      ...
      <div>
        {cartData.map((item, index) => {
          ...
          // Defensive check: productData might not exist!
          if (!productData) {
            return (
              <div key={index} className="py-4 border-t border-b text-red-500">
                Error: Product not found for id "{item.id}".
              </div>
            );
          }
            ...
            >
              <div className="flex items-start gap-6">
                <img
                  ...
                  src={productData.images?.[0] ?? assets.fallback_image}
